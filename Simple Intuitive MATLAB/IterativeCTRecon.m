...
%orig_object = flipud(rgb2gray(im2double(imread('cholangioca.jpg'))));
...
sg_rf = (1/mean(diff(r)))*rampFilt(sg);
...
recon_img_rf = backproj(r, theta, sg_rf, x, y, false); % Running Reconstruction
[r, sg_reproj] = sinogram(x, y, recon_img_rf, theta);
...
for iter = 1:numIter
    ...
    tic; sg_rf = (1/mean(diff(r)))*rampFilt(sg_err);
    filt_backproj_img = backproj(r, theta, sg_rf, x, y, false);
    [r, sg_reproj] = sinogram(x, y, filt_backproj_img, theta);
...
for iter = 1:numIter
    ...
    tic; gradient_backproj_img = backproj(r, theta, sg_err, x, y, false);
    [r, sg_reproj] = sinogram(x, y, gradient_backproj_img, theta);
